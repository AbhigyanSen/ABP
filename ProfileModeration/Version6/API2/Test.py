...
BASE_FOLDER = "/home/abp/Documents/ABPProduction/ABP/ProfileModeration/Version6/API2/Images"
YOLO_FOLDER = "/home/abp/Documents/ABPProduction/ABP/ProfileModeration/Version6/best.pt"

# Changes in Line Numbers: 77 79 313 348-350
...
def detect_nsfw(image_path):
    try:
        print(f"Image Path NSFW: {image_path}")
        img = cv2.imread(image_path)
        print(f"Image Shape NSFW: {img.shape}")
